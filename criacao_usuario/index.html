...
<form action="usuario.php" style="border:1px solid #ccc">
  <div class="container">
    <h1>Novo usuário</h1>
    ...
    <input type="date" name="data de nascimento" max="1979-12-31" min=" 2004-12-31" required><br>
    ...
    <input type="text" placeholder="Digite seu Número USP..." name="Número USP" >

    <label for="Endereço"><b>Endereço</b></label>
    <input type="text" placeholder="Digite seu Endereço..." name="Endereço" >

    <label>
      <input type="radio" name="nivel" value="1"> Alteta <br>
    ...
    <div class="clearfix">
      ...
      <button type="button" class="signupbtn">Criar</button>
    </div>
  </div>
</form>